...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18193817717868159)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18194116493868160)
,p_plug_template_id=>wwv_flow_api.id(18193817717868159)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18194480012868160)
,p_plug_template_id=>wwv_flow_api.id(18193817717868159)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18194707142868160)
,p_plug_template_id=>wwv_flow_api.id(18193817717868159)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18195058448868160)
,p_plug_template_id=>wwv_flow_api.id(18193817717868159)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18195339159868161)
,p_plug_template_id=>wwv_flow_api.id(18193817717868159)
,p_name=>'Sub Regions'
