...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18160501769868110)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18160821274868111)
,p_plug_template_id=>wwv_flow_api.id(18160501769868110)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18161193724868112)
,p_plug_template_id=>wwv_flow_api.id(18160501769868110)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18161460245868112)
,p_plug_template_id=>wwv_flow_api.id(18160501769868110)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18161771319868113)
,p_plug_template_id=>wwv_flow_api.id(18160501769868110)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18162012708868113)
,p_plug_template_id=>wwv_flow_api.id(18160501769868110)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18162395624868114)
,p_plug_template_id=>wwv_flow_api.id(18160501769868110)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18162625134868114)
,p_plug_template_id=>wwv_flow_api.id(18160501769868110)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18162956683868114)
,p_plug_template_id=>wwv_flow_api.id(18160501769868110)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18163282969868115)
,p_plug_template_id=>wwv_flow_api.id(18160501769868110)
,p_name=>'Sub Regions'
