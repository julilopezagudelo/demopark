...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18170064099868136)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18170304587868137)
,p_plug_template_id=>wwv_flow_api.id(18170064099868136)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18170617711868137)
,p_plug_template_id=>wwv_flow_api.id(18170064099868136)
,p_name=>'Change'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18170925080868137)
,p_plug_template_id=>wwv_flow_api.id(18170064099868136)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18171270128868137)
,p_plug_template_id=>wwv_flow_api.id(18170064099868136)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18171540057868138)
,p_plug_template_id=>wwv_flow_api.id(18170064099868136)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18171821235868138)
,p_plug_template_id=>wwv_flow_api.id(18170064099868136)
,p_name=>'Sub Regions'
