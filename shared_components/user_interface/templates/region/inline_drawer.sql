...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18182001080868150)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18182340359868150)
,p_plug_template_id=>wwv_flow_api.id(18182001080868150)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18182683732868150)
,p_plug_template_id=>wwv_flow_api.id(18182001080868150)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18182967912868151)
,p_plug_template_id=>wwv_flow_api.id(18182001080868150)
,p_name=>'Create'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18183258709868151)
,p_plug_template_id=>wwv_flow_api.id(18182001080868150)
,p_name=>'Delete'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18183544555868151)
,p_plug_template_id=>wwv_flow_api.id(18182001080868150)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18183830060868151)
,p_plug_template_id=>wwv_flow_api.id(18182001080868150)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18184198375868151)
,p_plug_template_id=>wwv_flow_api.id(18182001080868150)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18184438180868152)
,p_plug_template_id=>wwv_flow_api.id(18182001080868150)
,p_name=>'Sub Regions'
