...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18149000784868093)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18149366970868093)
,p_plug_template_id=>wwv_flow_api.id(18149000784868093)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18149631471868093)
,p_plug_template_id=>wwv_flow_api.id(18149000784868093)
,p_name=>'Sub Regions'
