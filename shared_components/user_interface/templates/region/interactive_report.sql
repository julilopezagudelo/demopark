...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18192044818868158)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18192392519868158)
,p_plug_template_id=>wwv_flow_api.id(18192044818868158)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18192634107868159)
,p_plug_template_id=>wwv_flow_api.id(18192044818868158)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18192903435868159)
,p_plug_template_id=>wwv_flow_api.id(18192044818868158)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18193235002868159)
,p_plug_template_id=>wwv_flow_api.id(18192044818868158)
,p_name=>'Sub Regions'
