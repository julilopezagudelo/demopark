...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18205805011868169)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18206177381868169)
,p_plug_template_id=>wwv_flow_api.id(18205805011868169)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18206468514868170)
,p_plug_template_id=>wwv_flow_api.id(18205805011868169)
,p_name=>'Tabs'
