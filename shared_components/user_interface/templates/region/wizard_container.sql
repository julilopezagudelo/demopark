...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18213207302868175)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18213578549868175)
,p_plug_template_id=>wwv_flow_api.id(18213207302868175)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18213899803868176)
,p_plug_template_id=>wwv_flow_api.id(18213207302868175)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18214141989868176)
,p_plug_template_id=>wwv_flow_api.id(18213207302868175)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18214494769868176)
,p_plug_template_id=>wwv_flow_api.id(18213207302868175)
,p_name=>'Previous'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18214769644868176)
,p_plug_template_id=>wwv_flow_api.id(18213207302868175)
