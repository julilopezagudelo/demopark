...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(18174253748868143)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18174584117868143)
,p_plug_template_id=>wwv_flow_api.id(18174253748868143)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18174863363868143)
,p_plug_template_id=>wwv_flow_api.id(18174253748868143)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18175177013868144)
,p_plug_template_id=>wwv_flow_api.id(18174253748868143)
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(18175401414868144)
,p_plug_template_id=>wwv_flow_api.id(18174253748868143)
,p_name=>'Sub Regions'
